...
<div class="login-container-wrapper">
    ...
    <label class="checkbox-wrapper">
        <a tabindex="4" href="${url.loginResetCredentialsUrl}" class="forgot-password-link">
            Забыли пароль?
        </a>
    </label>
</#if>
...
<div class="login-container-wrapper">
    ...
    <#-- Registration link below social buttons -->
    <div class="register-block">
        Нет аккаунта?
        <a href="${url.registrationUrl}" class="register-link">Зарегистрироваться</a>
    </div>
